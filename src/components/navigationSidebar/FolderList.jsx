import {Button, Dropdown, Empty, Input, Modal, Tree, Typography} from 'antd'
import {DeleteFilled, DownOutlined, EditFilled, FolderAddOutlined, FolderFilled, MoreOutlined} from '@ant-design/icons'
import {useDispatch, useSelector} from 'react-redux'
import {setActiveFolder, setActiveNote} from '../../store/general/generalSlice'
import {
  addNewSubFolder,
  moveAndDeleteFolders,
  removeFolderAndNotes,
  renameFolder
} from '../../store/folderList/folderListSlice'
  ...
  return (
    <>
      {folders.length > 0 ? (
        ...
        <Empty description={<span>Папок нет</span>}/>
      }
    </>
  )
